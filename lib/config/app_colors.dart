...
class AppColors {
  ...
  static const Color accentBlue = Color(0xFF66A0EE);

  // Text Colors
  static const Color darkGrey = Color(0xFF333333);
  static const Color mediumGrey = Color(0xFF757575);
  static const Color lightGreyText = Color(0xFFB0B0B0);
  ...
  // System/Feedback Colors (Optional but good to have)
  ...
  static const Color neumorphicBaseColor = Color(0xFFE0E0E0); // Base color for elements
  ...
  static const textgrey = Color(0xFF383737);
  static const whiteColor = Colors.white;
  static const Color darkblueColor = Colors.indigoAccent;
